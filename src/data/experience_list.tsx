...
export const experiences = [
    {
        ...
        description: (
            <ul>
                ...
                <li>
                    Skills: MySQL · Git · WebSocket · Jest · React Native · REST APIs · JSON · AJAX · TypeScript · LESS (Stylesheet Language) · SASS · HTML5 · Flow Type Testing · GraphQL · PHP · Python (Programming Language) · JavaScript · User Experience (UX) · jQuery · Cascading Style Sheets (CSS) · Keynote · Leadership · Teamwork · User Interface Programming · DHTML · User Interface Prototyping · React.js
                </li>
            </ul>
        ),
